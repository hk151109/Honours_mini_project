# train_firenet.py
# FireNet-CNN training script
#
# Stage 3: FireNet Implementation
# Architecture: FireNet-CNN (see paper: https://arxiv.org/pdf/1905.11922)
# Specs: Custom 5-block convolutional neural network designed for fire
#        detection in imagery. Uses moderate channel widths and a compact
#        MLP classification head.
# Input: 150x150 RGB images (shape: 150x150x3)
# Training procedure implemented here:
#  - Stage A: Freeze convolutional base and train MLP head (short run)
#  - Stage B: unfreeze the full network and fine-tune at lower LR
# Outputs saved under `./FireNetCNNOutput` (models, plots, logs).
#
# Usage:
